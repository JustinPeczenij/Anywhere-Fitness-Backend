...
const addReservation = async (ids) => {
    ...
    return db('Classes').where('class_id', ids.class_id).first()
}
...
const deleteReservation = (class_id, user_id) => {
    return db('Class_Client_Reservations').where({ class_id, user_id }).del()
}
